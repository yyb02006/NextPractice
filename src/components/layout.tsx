		...
		<div className='bg-[#101010] relative'>
			...
			{hasTabBar ? (
				<nav className='fixed flex pb-4 h-24 justify-around items-center bottom-0 w-full max-w-lg bg-[#1a1a1a] sha'>
					<Link href='/'>
						<div className='flex flex-col items-center text-gray-300 space-y-1 w-16'>
							<svg
								xmlns='http://www.w3.org/2000/svg'
								fill='none'
								viewBox='0 0 24 24'
							...
							<span className='text-xs font-medium'>집구석</span>
						</div>
					</Link>
					<Link href='/live-streams'>
						<div className='flex flex-col items-center text-gray-300 space-y-1 w-16'>
							...
							<span className='text-xs font-medium'>라이브</span>
						</div>
					</Link>
					...
					<Link href='/chats'>
						<div className='flex flex-col items-center text-gray-300 space-y-1 w-16'>
							...
							<span className='text-xs font-medium'>랩배틀</span>
						</div>
					</Link>
					<Link href='/profiles'>
						<div className='flex flex-col items-center text-gray-300 space-y-1 w-16'>

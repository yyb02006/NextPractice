			...
			{pos === 'left' ? (
				<div className='flex items-start gap-2 mt-4 bg-[#1a1a1a] p-4'>
					...
					<div>
						...
						<div className='font-SCoreDream font-normal text-sm leading-6 text-gray-200 w-[80%] break-keep'>
							{text}
						</div>
					</div>
				</div>
			...
			{pos === 'right' ? (
				<div className='flex justify-end items-start gap-2 mt-4 bg-[#1a1a1a] p-4'>
					<div className='flex flex-col items-end'>
						<div className='font-normal text-xs text-gray-400'>{name}</div>
						<div className='font-SCoreDream font-normal text-sm leading-6 text-left text-gray-200 w-[80%] break-keep'>
							{text}
						</div>
					</div>

			...
			<div className='mt-16 h-[42vh] overflow-y-scroll scroll-'>
				<div className='flex items-start gap-2 mt-4 bg-[#1a1a1a] p-4'>
					...
					<div>
						...
						<div className='font-SCoreDream font-light text-sm leading-6 text-gray-300 min-w-5/6'>
				...
				<div className='flex justify-end items-start gap-2 mt-4 bg-[#1a1a1a] p-4'>
					<div className='flex flex-col items-end'>
						...
						<div className='font-SCoreDream font-light text-sm leading-6 text-right text-gray-300 min-w-5/6'>
